...
panorama = new PANOLENS.ImagePanorama('imagenes/examen/salaquiru.jpg');
...
infospot2.addEventListener('click', function() {
    window.open("pdfexamen/ecografo.pdf", "_blank");
});
...
<div style="background-color: rgba(0,0,0,0.8); color: white; padding: 12px; border-radius: 8px; width: 260px;">
    ...
    <br>
    <img src="imagenes/examen/medicina.svg" alt="Imagen medicina" style="max-width: 100%; height: auto; border-radius: 5px">
    <br>
</div>
`
...
<div style="background-color: rgba(0,0,0,0.8); color: white; padding: 12px; border-radius: 8px; width: 260px;">
    ...
    <br>
    <img src="imagenes/examen/mesaquirur.svg" alt="Imagen medicina" style="max-width: 100%; height: auto; border-radius: 5px">
    <br>
</div>
`
...
<div style="background-color: rgba(0,0,0,0.8); color: white; padding: 12px; border-radius: 8px; width: 260px;">
    ...
    <br>
    <img src="imagenes/examen/medicina2.svg" alt="Imagen medicina" style="max-width: 100%; height: auto; border-radius: 5px">
    <br>
</div>
`
